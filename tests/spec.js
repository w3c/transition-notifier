...
promise_test(() => {
  const s = loadSpec("https://www.w3.org/TR/2018/CR-hr-time-2-20180301/");
  return s.then(s => {
...
promise_test(() => {
  const s = loadSpec("https://www.w3.org/TR/2018/CR-payment-request-20180718/");
  return s.then(s => {
...
promise_test(() => {
  const s = loadSpec("https://www.w3.org/TR/2018/WD-css-display-3-20180420/");
  return s.then(s => {
...
promise_test(() => {
  const s = loadSpec("https://www.w3.org/TR/2018/CR-webrtc-stats-20180703/");
  return s.then(s => {
...
promise_test(() => {
  const s = loadSpec("https://www.w3.org/TR/2018/WD-wai-aria-practices-1.2-20180719/");
  return s.then(s => {
