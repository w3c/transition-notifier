...
promise_test(() => {
  const s = loadSpec({href: "https://api.w3.org/specifications/hr-time-2/versions/20180301"});
  return s.then(s => {
...
promise_test(() => {
  const s = loadSpec({href: "https://api.w3.org/specifications/payment-request/versions/20180301"});
  return s.then(s => {
...
promise_test(() => {
  const s = loadSpec({href: "https://api.w3.org/specifications/css-display-3/versions/20180420"});
  return s.then(s => {
...
promise_test(() => {
  const s = loadSpec({href: "https://api.w3.org/specifications/webrtc-stats/versions/20180703"});
  return s.then(s => {
...
promise_test(() => {
  const s = loadSpec({href: "https://api.w3.org/specifications/wai-aria-practices-1.2/versions/20180719"});
  return s.then(s => {
